...
`xless` is a Rust pager with less-style navigation, safe ANSI color pass-through, horizontal scrolling for chopped lines, mark/jump navigation, multi-file jumps, blank-line squeezing, configurable tab stops, and syntax highlighting for common source files.
