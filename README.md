...
- Less-style navigation, startup commands like `+42`, `+/pattern`, `+G`, and `+F`, startup search with `-p/--pattern`, incremental search over visible text, mark/jump keys, blank-line squeezing, and editor handoff.
