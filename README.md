...
- Less-style navigation, counted motions, startup commands like `+42`, `+/pattern`, `+G`, and `+F`, startup search with `-p/--pattern`, incremental search over visible text, mark/jump keys, horizontal scrolling for chopped long lines, blank-line squeezing, and editor handoff.
